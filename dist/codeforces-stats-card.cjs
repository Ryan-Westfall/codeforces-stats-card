...
__export(exports_src, {
  rankFromRating: () => rankFromRating,
  rankColor: () => rankColor,
  default: () => src_default,
  CodeforcesCard: () => CodeforcesCard
});
...
function CodeforcesCard({
  ...
  const [state, setState] = import_react.useState({ status: "loading" });
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          ...
          showRank && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV(RatingGraph, {
        history,
...
function Header({ title, profileUrl }) {
  const content = /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    className: "cfsc-header",
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
        className: "cfsc-title",
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV(CodeforcesLogo, {}, undefined, false, undefined, this),
          title
        ]
      }, undefined, true, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
...
function RatingGraph({ history, currentRating }) {
  ...
  const model = import_react.useMemo(() => {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("svg", {
        ...
        children: [
          ...
          model.points.map((p, i) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("circle", {
            cx: p.x,
            cy: p.y,
            r: "2.6",
            fill: rankColor(p.r),
...
//# debugId=764F666041C6AA4864756E2164756E21
